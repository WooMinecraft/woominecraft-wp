		...
		<table class="wc_shipping widefat" cellspacing="0">
			...
			<?php $count = 0; foreach ( woo_minecraft()->admin->get_servers() as $server ) : ?>
				<tr>
					...
					<td class="wmc_name"><input type="text" name="wmc_servers[]" value="<?php echo $server['name']; ?>" /></td>
					<td class="wmc_key"><input type="text" name="wmc_servers[]" value="<?php echo $server['key']; ?>" class="widefat" /></td>
